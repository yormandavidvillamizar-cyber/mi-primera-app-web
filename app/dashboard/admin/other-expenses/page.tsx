...
import { Loader2, ArrowLeft, ShieldX, Wallet } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 dark:bg-gray-950">
      <header className="flex items-center justify-between border-b bg-background px-4 py-3 sm:px-6">
        <h1 className="text-xl font-semibold">Otros Gastos</h1>
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-6 p-4 sm:p-6">
        <div className="flex flex-col items-center gap-4 text-center">
            ...
            <h2 className="text-2xl font-bold">Registro de Otros Gastos</h2>
            <p className="max-w-md text-muted-foreground">
                Aquí podrás registrar y consultar gastos de aserrada, cercas, comida, mantenimiento y más. Esta sección está en construcción.
            </p>
        </div>
      </main>
    </div>
